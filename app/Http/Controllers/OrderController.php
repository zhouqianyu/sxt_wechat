...
class OrderController extends Controller
{
    public function myOrder(){
        ...
        switch ($type){
            case 1:$typeArr=[1,2,3];break;
            case 2:$typeArr=[4];break;
            case 3:$typeArr=[5];
        }
    ...
    public function view()
    {
        ...
        return view('order', ['data' => $cart, 'total' => $total]);
    }
    ...
    public function confirm()
    {
        ...
        if (!$bill) {
            ...
            return view('orderSubmitted', ['data' => $cart, 'total' => $total, 'id' => $bill->id]);
        } else {
            $total = $bill->price;
            $totalAdd = 0;
            foreach ($cart as $v) {
            ...
            $bill->save();
            Cart::where('user_id', $userId)->delete();
            return view('orderAddFood', ['data' => $cart, 'total' => $totalAdd, 'id' => $bill->id]);
        }
